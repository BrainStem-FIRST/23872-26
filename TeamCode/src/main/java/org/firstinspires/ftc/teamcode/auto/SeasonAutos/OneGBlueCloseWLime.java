...
@Autonomous(name="1 Gate Close - Blue with Limelight", group = "BLUE")
@Config

public class OneGBlueCloseWLime extends LinearOpMode {
    ...
    public static OneGBlueCloseWLime.PARAMS PARAMS = new OneGBlueCloseWLime.PARAMS();
...
//        );
        DrivePath driveToSetupSpike1 = new DrivePath(robot.drive, telemetry,
...
//        );
        DrivePath driveToSetupSpike2 = new DrivePath(robot.drive, telemetry,
                new Waypoint(createPose(collect2Mid)),
