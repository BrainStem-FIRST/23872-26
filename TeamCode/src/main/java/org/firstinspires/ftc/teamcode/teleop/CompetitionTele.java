...
//        robot = new BrainSTEMRobot(hardwareMap, this.telemetry, this, new Pose2d(0, 0, 0));
    ...
    private void updateD1Buttons() {
        ...
        if ((wasHit && pressedTime.milliseconds() > 2500 && (robot.shooter.isShooterFar())) || (wasHit && pressedTime.milliseconds() > 2000 && robot.shooter.isShooterClose())) {
